...
CREATE TABLE public.project_scoring_config (
    ...
    score_value numeric DEFAULT 0.0 NOT NULL,
    prerequisite text,
...
CREATE TABLE public.project_total_scores (
    id integer NOT NULL,
    project_id integer NOT NULL,
    information_score numeric DEFAULT 0.0,
    quotation_score numeric DEFAULT 0.0,
    stage_score numeric DEFAULT 0.0,
    manual_score numeric DEFAULT 0.0,
...
--
-- Name: project_rating_records fk_project_rating_project_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_rating_records
    ADD CONSTRAINT fk_project_rating_project_id FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;


--
-- Name: project_rating_records fk_project_rating_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_rating_records
    ADD CONSTRAINT fk_project_rating_user_id FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
