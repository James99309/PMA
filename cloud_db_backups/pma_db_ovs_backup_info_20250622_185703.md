...
- **主机**: dpg-d170laodl3ps739trgp0-a.singapore-postgres.render.com
- **用户**: pma_db_ovs_user
- **数据库**: pma_db_ovs
...
```bash
pg_dump --verbose --clean --no-owner --no-privileges --format=plain --file cloud_db_backups/pma_db_ovs_backup_20250622_185703.sql postgresql://pma_db_ovs_user:oUKdxwqXDvCrgkg3fkZ33axXgDF21D51@dpg-d170laodl3ps739trgp0-a.singapore-postgres.render.com/pma_db_ovs
```
...
pg_dump: 删除 FK CONSTRAINT settlement_order_details fk_settlement_order_details_settlement_company
pg_dump: 删除 FK CONSTRAINT approval_record fk_approval_record_step_id
pg_dump: 删除 FK CONSTRAINT approval_record fk_approval_record_approver_id
...
pg_dump: 删除 CONSTRAINT approval_record approval_record_temp_pkey
...
pg_dump: 创建CONSTRAINT "public.approval_record approval_record_temp_pkey"
...
pg_dump: 创建FK CONSTRAINT "public.approval_record fk_approval_record_approver_id"
pg_dump: 创建FK CONSTRAINT "public.approval_record fk_approval_record_step_id"
pg_dump: 创建FK CONSTRAINT "public.settlement_order_details fk_settlement_order_details_settlement_company"
