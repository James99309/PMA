...
- **备份时间**: 2025-06-22 18:52:25
- **源数据库**: Render PostgreSQL (Singapore)
- **数据库名**: pma_db_ovs
- **备份文件**: cloud_db_backup_20250622_185221.sql
- **文件大小**: 229.19 KB
- **备份格式**: SQL (plain text)
...
```bash
pg_dump --verbose --clean --no-owner --no-privileges --format=plain --file cloud_db_backups/cloud_db_backup_20250622_185221.sql postgresql://pma_db_ovs_user:oUKdxwqXDvCrgkg3fkZ33axXgDF21D51@dpg-d170laodl3ps739trgp0-a.singapore-postgres.render.com/pma_db_ovs
```
