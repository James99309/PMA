...
from app.api.v1 import mobile_projects, mobile_approval, mobile_customers, mobile_push, mobile_quotation, mobile_chat, mobile_expense
from app.api.v1 import ota