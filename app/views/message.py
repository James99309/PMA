    ...
    try:
        ...
        for mr in milestone_reviews:
            ...
            todo_list.append({
                ...
                'status': 'pending',
                'title': f'{_("里程碑确认")}: {st.title}',
                'message': _('任务「%(task)s」的节点「%(node)s」已完成，请确认', task=task_title, node=st.title),
        ...
        for tr in task_reviews:
            ...
            todo_list.append({
                ...
                'type': 'task_review',
                'status': 'pending',
                'title': f'{_("任务审核")}: {t.title}',
                'message': _('任务「%(task)s」已完成，请审核', task=t.title),
