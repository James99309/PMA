...
基于SP8D当前版本 03eaf48bf549 创建

Revision ID: sp8d001_tables
...
def upgrade():
    ...
    print("✅ SP8D第一阶段迁移完成：已添加 company_assets 和 temp_products 表")


def downgrade():
    """安全回滚：删除添加的表"""
    
    print("⚠️  开始回滚SP8D第一阶段迁移...")
