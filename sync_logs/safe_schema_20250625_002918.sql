...
CREATE TABLE IF NOT EXISTS public.action_reply (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.approval_instance (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.approval_process_template (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.approval_step (
    id integer NOT NULL,
    process_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.dev_product_specs (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.dev_products (
    id integer NOT NULL,
    category_id integer,
...
CREATE TABLE IF NOT EXISTS public.five_star_project_baselines (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.pricing_order_approval_records (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.pricing_order_details (
    id integer NOT NULL,
    pricing_order_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.product_code_field_options (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.product_code_field_values (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.product_code_fields (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.project_rating_records (
    id integer NOT NULL,
    project_id integer NOT NULL,
    user_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.project_scoring_config (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.project_scoring_records (
    id integer NOT NULL,
    project_id integer NOT NULL,
    category character varying(50) NOT NULL,
    field_name character varying(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.project_total_scores (
    id integer NOT NULL,
    project_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.settlement_order_details (
    id integer NOT NULL,
    pricing_order_id integer NOT NULL,
    product_name character varying(255) NOT NULL,
    product_model character varying(128),
...
CREATE TABLE IF NOT EXISTS public.solution_manager_email_settings (
    id integer NOT NULL,
    user_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.version_records (
    id integer NOT NULL,
...
CREATE INDEX IF NOT EXISTS ix_project_stage_history_project_id ON public.project_stage_history USING btree (project_id);
...
CREATE INDEX IF NOT EXISTS ix_projects_authorization_code ON public.projects USING btree (authorization_code);
...
CREATE INDEX IF NOT EXISTS ix_projects_project_name ON public.projects USING btree (project_name);
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_system_settings_key ON public.system_settings USING btree (key);
