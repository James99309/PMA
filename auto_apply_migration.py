...
def apply_migration():
    ...
    try:
        ...
        with engine.begin() as conn:
            ...
            migration_needed = not (projects_has_shared_users and projects_has_share_enabled)
            ...
            if not projects_has_shared_users:
                print("🔧 为projects表添加shared_with_users字段...")
            ...
            # 4. 关闭客户的项目自动共享功能（关键：解决zhouyj权限异常）
            print("\n🔒 关闭客户项目自动共享功能...")
            ...
            if zhouyj_companies:
                ...
                print("  ℹ️  未发现zhouyj相关的客户共享（或已全部禁用）")
