...
|---------|---------|---------|-----------|------|
| at-tree-select.js | AT 公司▸部门▸账户 树形多选(可展开折叠+三态父级全选/半选+搜索+全选/清空,喂扁平用户数组内部建树) | 跨公司/部门选人选范围:归属授权/共享/通知抄送/范围授权 | 1 | ✅ 已文档化 🆕 |
| at-batch-select.js | AT 列表批量选择组件(默认无复选框,进入「批量模式」才出现,跨页保留+整行可勾选) | 列表页多选导出/批量操作(报价单/批价单导出) | 2 | ✅ 已文档化 🆕 |
